  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="logout.jsp">LogOut</a></li>
                ...
                <div class="col-sm-10" style="height:589px;overflow: scroll">
                    <br>
                    ...
                    String command="select * from admitcard where rank='"+rank+"'";
                    ...
                    <tr>
                        ...
                        <td><a href="../admitcard/<%=rs.getString(6)%>">Download</a></td>
                    </tr>
