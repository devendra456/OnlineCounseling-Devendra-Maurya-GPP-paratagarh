  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="logout.jsp" onclick="setPosuvnik(12)">LogOut</a></li>
                ...
                <div class="col-sm-10">
                     <br>
                     <h1 style="color:#2098d1;text-align: center;font-family: sans-serif">Courses</h1>
              <div class="row">
        <div class="col-sm-3"></div>
        <form action="../codes/coursecode.jsp" method="post">
            <div class="col-sm-6" style="border:3px solid yellowgreen;padding:3%;background: powderblue">
           Collage Code : <input type="number" name="code" class="form-control"><br>     
            Collage Name : <input type="text" name="name" class="form-control"><br>
