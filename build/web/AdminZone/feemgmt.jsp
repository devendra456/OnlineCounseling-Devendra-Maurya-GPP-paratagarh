...
<script>
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="changepass.jsp" onclick="setPosuvnik(10)">Change Password</a></li>
      <li role="separator" class="divider"></li>
      <li><a href="logout.jsp" onclick="setPosuvnik(11)">LogOut</a></li>
    </ul>
  </div>
</ul>
                </div>
                <div class="col-sm-10">
                      ...
                      <br>
              <div class="row" style="text-align:center;font-size: 35px;font-family: monospace"><b>Students Fees Management</b></div> 
                ...
                String command="select * from submitfee";
