    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="logout.jsp" onclick="setPosuvnik(12)">LogOut</a></li>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <a href="#">  <span  class="fa fa-envelope"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                </div>
            </div>
            <div class="row" style="text-align: center">
                <div class="col-sm-12">
                    <div class="col-sm-4">
                       <a href="#"> <span  class="fa fa-newspaper-o"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                    <div class="col-sm-4">
                       <a href="#"> <span  class="fa fa-paperclip"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-4">
                       <a href="#"> <span  class="fa fa-eye-slash"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                    <div class="col-sm-4">
                       <a href="#"> <span  class="fa fa-adn"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#"> <span  class="fa fa-"style="font-size: 100px;margin:40px"></span></a>
                    </div>
                </div>
            </div>
                </div>
