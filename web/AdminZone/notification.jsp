    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="logout.jsp" onclick="setPosuvnik(12)">LogOut</a></li>
                ...
                <div class="col-sm-10">
                     <br>
                    <div class="row">
                        <center><h1>Enter Notifications</h1></center>
                        
                        <div class="col-sm-2"></div>
                      <form action="../codes/notificode.jsp" method="post">
                        <div class="col-sm-8" style="border:2px solid #99c;padding: 2%;border-radius: 12px;background: oldlace">
                          <lable style="font-size:18px">Enter Notification</lable><textarea class="form-control"
                                                                                          row="5"  placeholder="Enter Notification" name="noti" ></textarea>
                    <br><input type="submit" value="Add Notification" class="btn-success">
                      </div>
                        </form>
                        <div class="col-sm-2"></div>
                    </div>
