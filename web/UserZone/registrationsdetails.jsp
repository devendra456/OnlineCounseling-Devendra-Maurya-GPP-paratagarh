  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" style="font-size:16px;padding:2%; text-align: center;">
      ...
      <li><a href="logout.jsp">LogOut</a></li>
                ...
                <div class="col-sm-10">
                    <br>
                 <center>   <h3 style="color:teal">Student Registration Details</h3></center>
                 <br><br>
                  <div class="row">
                      <div class="col-sm-1"></div>
                      <div class="col-sm-10">
                          <div class="row" style="background: #FCF7E5;padding: 4%;height:300px;font-size:16px;border: 2px solid goldenrod">
                        <%
